...
const Toolbar = (props: Props) => {
  ...
  return (
    <div className="sticky top-10 z-50 mb-6">
      <div className="border flex-wrap rounded-lg p-1 flex items-center gap-2 border-neutral-200 shadow-sm hover:text-neutral-900 dark:border-neutral-800 dark:hover:text-neutral-50 ">
