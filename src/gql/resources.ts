...
export const requestNewsStatisticsByProductId = async (
  selection: Partial<Record<keyof NewsStatistics, boolean>>,
  args: { productId: string }
) => {
  const fields = Object.entries(selection)
    .filter(([_, include]) => include)
...
export const requestNewsById = async (
  selection: Partial<Record<keyof News, boolean>>,
  args: { id: string }
) => {
  const fields = Object.entries(selection)
...
export const requestLogin = async (
  selection: Partial<Record<keyof Token, boolean>>,
